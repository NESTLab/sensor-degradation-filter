...
INIT_VAR=1e-4                  # initial variance for the filter (the initial mean will be the initial assumed sensor accuracy)
...
ASSUMED_ACC=(999 800) # when flawed robots num is set to 0 this isn't applied
