...
def save_to_h5(json_data_lst, args):
    ...
    if (sensor_acc_df["tfr"].unique() != unique_tfrs or
        sensor_acc_df["flawed_sensor_acc_b"].unique() != unique_flwbs or
        sensor_acc_df["correct_sensor_acc_b"].unique() != unique_corbs):
